...
[Releases page](https://github.com/Foundation-CCC/google-codelabs-tools/releases/latest).

Alternatively, if you have [Go installed](https://golang.org/doc/install):

    go install github.com/Foundation-CCC/google-codelabs-tools/claat@latest
...
2. Make sure this directory is placed under
   `$GOPATH/src/github.com/Foundation-CCC/google-codelabs-tools`.
